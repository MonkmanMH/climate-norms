...
This file creates a single csv file with climate norms sourced from the Japan Meteorological Agency.
...
write_csv(japan_climate, here("data", "japan_climate.csv"))
